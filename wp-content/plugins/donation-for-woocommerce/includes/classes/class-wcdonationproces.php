...
class WcdonationProces {
	...
	public function add_popup_before_order () {
		...
		if ( isset( $_POST['nonce'] ) && !wp_verify_nonce(sanitize_text_field($_POST['nonce']), self::$addDonationToOrderActionName )) {
			exit( 'Not Authorized' );
		}
	...
	public function loadAdminScripts() {
		...
		$parameters = array (
			...
			'amount_l_text' => esc_html( __( 'Amount', 'wc-donation' ) ),
			'amount_p_text' => esc_html( __( 'Enter Amount', 'wc-donation' ) ),
			'label_l_text' => esc_html( __( 'Label', 'wc-donation' ) ),
			'label_p_text' => esc_html( __( 'Enter Label', 'wc-donation' ) ),
			'donation_level_text' => esc_html( __( 'Donation Level', 'wc-donation' ) ),
		);
		wp_register_script( 'wc-donation-admin-script', WC_DONATION_URL . 'assets/js/admin.js', array( 'jquery' ), WC_DONATION_VERSION, true );		
		wp_localize_script( 'wc-donation-admin-script', 'wcds', $parameters );
		wp_enqueue_script( 'wc-donation-admin-script' );
		wp_enqueue_script( 'wc-donation-jscolor-script', WC_DONATION_URL . 'assets/js/jscolor.js', array( 'jquery' ), WC_DONATION_VERSION, true );
	...
	public function loadFrontendScripts() {
		...
		wp_register_script( 'wc-donation-frontend-script', WC_DONATION_URL . 'assets/js/fronend.js', array( 'jquery' ), WC_DONATION_VERSION, true );
		wp_localize_script( 'wc-donation-frontend-script', 'wcOrderScript', $parameters );
		wp_enqueue_style( 'trustseal_style', WC_DONATION_URL . '/assets/css/user-wc-donation-form.css', array(), WC_DONATION_VERSION );
