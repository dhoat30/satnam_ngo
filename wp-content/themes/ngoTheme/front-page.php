        ...
        <div class="slide" style='background: url("<?php echo get_the_post_thumbnail_url(null, 'full');?>") no-repeat
            ...
            <div class="content">
                <div class="banner_content overflow-hidden">
                    <h2 class="em-slider-sub-title" data-animation="slideInLeft" data-animation-delay="0.5s">
                        <?php echo get_field('title');?></h2>
                    <h5 class="em-slider-descript" data-animation="slideInLeft" data-animation-delay="1s">
                        <?php echo get_field('subtitle');?></h5>
                    <?php if(get_field('button_text')){
                                                                ?>
                    <div class="em-slider-button wow  bounceInUp  em-button-button-area" data-wow-duration="3s"
                        data-wow-delay="0s">

                        <a data-animation-delay="1.5s" class='em-active-button'
                            href="<?php echo get_field('button_link');?>" data-animation="slideInLeft"
                            data-animation-delay="1.5s"><?php echo  get_field('button_text');?></a>
                    </div>
                    <?php
                                                            }?>
                </div>
                ...
                <div class="single_event_adn  kc-elm kc-css-73682">
                    <div class="astute-single-event_adn ">
                        ...
                        <div class="astute-event-thumb_adn">
                            <img width="950" height="550" src="<?php echo get_the_post_thumbnail_url(null, 'small'); ?>"
                                class="attachment-astute-event-default size-astute-event-default wp-post-image" alt="">
                        ...
                        <div class="em-event-content-area_adn ">
                            ...
                            <div class="event-page-title_adn ">
                                ...
                                <div class="astute-event-meta-left_adn">
                                    ...
                                    <span><i
                                            class="fa fa-map-marker"></i><?php echo get_field('event_location');?></span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="about_text">
                    <p>
                        Shah Satnam Ji Green ‘S’ Welfare Force was formed in India by Saint Gurmeet Ram Rahim Singh Ji
                        Insan in 2006.  The organisation was initially formed to help humanity in distress by mobilising
                        during natural disasters and today it has expanded its membership and scope.
                    </p>
                    <p>
                        Our organization has been participating in tasks that include providing relief in times of
                        natural calamities. We also work towards eradicating evils like female feticide, drug addiction
                        etc. Regular and ongoing blood donation camps are another important exercise where our
                        organisation has made a mark for itself in this world. It is internationally reputed for its
                        enthusiasm to serve humanity.
                    </p>
                    <p>
                        Under the leadership of Gurmeet Ram Rahim Singh Ji Insan , Shah Satnam Ji Green ‘S’ Welfare has
                        bagged place in Guinness Book For World Records, Asia Book Of Records, Limca Book Of Records and
                        India Book Of Records for various welfare works held from time to time. Highest blood donations,
                        tree plantation, eye testing, blood pressure examination, eco testing, cholesterol testing are
                        few names from the list of the records attained. 
                    </p>
                    <p>
                        The first Guinness World Record was awarded for largest Blood Donation Camp held on December 7,
                        2003 by 15,432 donors and this record was challenged by the organisation itself by forming
                        another record in same field on August 8, 2010 where 43,732 donors participated,
                    </p>
                    <p>
                        The Green ‘S’ Welfare Force in New Zealand works closely with local government councils and
                        other community organizations to carry out the welfare tasks. The team in NZ is actively
                    ...
                    <ul class="about-list">
                        ...
                        <li>
                        Cloth, Toys and Miscellaneous items donation 
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class=" single_image">
                    <img src="https://www.diocesan.school.nz/uploads/438e1b010d2f63a107988b53ec189d2c.jpg" class=""
                        alt="About Us">
                </div>
            </div>
        </div>
                ...
                <div class="single_plases">
                    <div class="single_plases_inner">
                        ...
                        <div class="plases_text">
                            <a href="mailto:<?php echo get_field('email_');?>">
                                <p><?php echo get_field('email_');?></p>
                            </a>
                        </div>
                    </div>
                </div>
