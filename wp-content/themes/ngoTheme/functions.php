...
require get_theme_file_path('/inc/nav-registeration.php');
 ...
 function liquorHut_scripts(){ 
   ...
   if (strstr($_SERVER['SERVER_NAME'], 'localhost')) {
      ...
      wp_enqueue_script('main', get_theme_file_uri('/bundled-assets/scripts.7102269301525ceec689.js'), NULL, '1.0', true);
      wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.7102269301525ceec689.css'));
    }
